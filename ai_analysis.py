...
def analyze_article(article: Dict[str, Any], model: str = "gpt-4o-mini") -> Dict[str, Any]:
...
def analyze_articles(
    ...
    for article in articles[:limit]:
        try:
            ...
            print(f"[AI] ✓ Analyzed: {article.get('title', '')[:60]}")
        except Exception as exc:
            print(f"[AI] ✗ Failed to analyze '{article.get('title', '')[:60]}': {exc}")
